      ...
      <Card className="w-full max-w-4xl mx-auto shadow-xl">
        <CardHeader>
          ...
          <CardDescription className="text-center text-green-500">
            Practice your speech in real-time with AI feedback
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Tabs
            ...
            <TabsContent value="record" className="space-y-4">
              ...
              <div className="flex justify-center items-center space-x-4">
                <Button
                  ...
                  className="w-40 h-40 rounded-full flex flex-col items-center justify-center bg-green-600 text-white hover:bg-green-700"
        ...
        <CardFooter className="flex justify-center">
          <p className="text-sm text-green-500">
            Select a language, then click the microphone button to start or stop
